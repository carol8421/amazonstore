...
class PageTemplater {
	...
	private function __construct() {
        $this->templatePath = plugin_dir_path( dirname( __FILE__ ) ). 'public/themes/'. AS_THEME_NAME .'/';
        //$this->templates = array();
		$this->templateNames = json_decode(AS_AMAZON_PAGES); // pages array
		...
		// ==============================================================================================
		$templateNames = [];
		if (!empty($this->templateNames)) {
			foreach ($this->templateNames as $value) {
				$fileName = strtolower(str_replace(' ', '_', $value)).'.php';
				$name = $value;
		...
		// $this->templates = array(
		// 	'login-teacher.php' => 'Login Teacher',
		// 	'profile-teacher.php' => 'Profile Teacher',
		// 	'search-teacher.php' => 'Search Teacher',
		// 	'example.php' => 'Example',
		// );
	}
